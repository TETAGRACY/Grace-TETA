...
###Datasource:https://en.wikipedia.org/wiki/List_of_countries_by_GDP_(PPP)_per_capita
```{r}
...
plot(Index_inequality.df, pch=20, col="red",
     xlim=c(3,9), ylim=c(-1.5,2.5), ann=FALSE)
